...
|---|---|
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Internal structure, data flows, component breakdown, integration points |
| [CONTRIBUTING.md](./CONTRIBUTING.md) | Dev setup (devcontainer), all available commands, CI/CD, release process |
| [docs/ADRs/](./docs/ADRs/) | Why key decisions were made (PHP 8, Guzzle, PSR interfaces, BC policy, devcontainers) |
| [AGENTS.md](./AGENTS.md) | Agent-first guide: sharp edges, invariants, quick reference |
| [.bito/guidelines/](./.bito/guidelines/) | PR review rules and domain invariants for automated review
